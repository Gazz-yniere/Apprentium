...
def generate_english_full_exercises(types, n_complete, n_relier, n_mots_reliés, selected_themes=None):
    ...
    """
    # print(f"DEBUG AnglaisGen: Thèmes reçus pour génération: {selected_themes}, "
    #       f"Types: {types}, NComplete: {n_complete}, NRelier: {n_relier}, "
    #       f"NMotsRelies: {n_mots_reliés}")  # DEBUG
    exercises = []
    ...
    if n_relier > 0 and n_mots_reliés > 0 and MOTS_A_RELIER:
        ...
        # else:
            # print("Avertissement: Aucun mot à relier disponible pour les thèmes sélectionnés ou aucun mot défini.")  # noqa: E501
